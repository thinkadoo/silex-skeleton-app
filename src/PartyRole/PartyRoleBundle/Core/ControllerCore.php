 ...
 */
namespace PartyRole\PartyRoleBundle\Core;
 ...
 *
 * @category Api_Rest_Implementation
 * @package  PartyRole\PartyRoleBundle\Core
 * @author   Andre Venter <andre.n.venter@gmail.com>
 * @license  Thinkadoo http://think-a-doo.net
 * @link     https://github.com/thinkadoo/silex-skeleton-app.git
 */
class ControllerCore implements ControllerProviderInterface
{
    ...
    public function connect(Application $app)
    {
        ...
        $targetRepository = "PartyRole\\PartyRoleBundle\\Repository\\" . $this->repository . "Repository";
